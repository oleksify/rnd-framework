...
#
# Responsibilities:
#   1. Fast-path exit when no tight-loop base dir is available
#   2. Skip non-code files and .tight-loop/ artifact paths
...
# ---------------------------------------------------------------------------
# Fast-path: skip if base dir is not available
# ---------------------------------------------------------------------------

session_dir="$(tight_base_dir 2>/dev/null || true)"
...
# ---------------------------------------------------------------------------
# Skip non-code files and .tight-loop/ artifact paths
# ---------------------------------------------------------------------------
