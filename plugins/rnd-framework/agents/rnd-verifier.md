...
- Every finding is a finding regardless of when it was introduced. Do not set aside a finding as "pre-existing", "by design", or "not in scope" without citing specific documentation that justifies the exception.
