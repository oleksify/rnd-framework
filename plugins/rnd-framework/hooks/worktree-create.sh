...
# Records a worktree_created event to $RND_DIR/audit.jsonl. Always exits 0.
...
"${plugin_root}/lib/audit-event.sh" worktree_created "$session_id" "$wt_path" 2>/dev/null || true
